...
function importSolutions(){
    ...
    foreach ($tabC as $keyC=>$vC){
        $query2 = $db->insert("fd_categories",
                ['id'=>$vC['id'], 'name'=>$vC['name'],'description'=>$vC['description'],'created_at'=>$vC['created_at'],'updated_at'=>$vC['updated_at']]);
...
//$r3 = updateUser_signup();
//$r3 = importAgents('kaori.morita@tpo.me');
