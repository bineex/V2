...
$lang = array_merge($lang,array(
	"SECTION_HOME_TITLE"		=> "<strong>Do you have someone to rely on outside of your family?</strong><br><br>Our concierges are here at your side, to support you.<br><br>It doesn’t matter if it takes us time,<br>we offer human-centered service so you can feel our care.<br><br>We want to help you live your own Happiness.",    
        ...
        "SECTION_NEWS_SUBTITLE"		=> "From us to you - information about the YourConcierge service",
        "SECTION_EXAMPLE_TITLE"		=> "REQUEST EXAMPLES",
        "SECTION_EXAMPLE_SUBTITLE"	=> "Gain inspiration from past requests",
        "SECTION_EVENT_TITLE"		=> "EVENTS",
        "SECTION_EVENT_SUBTITLE"        => "From us to you - book and join our events<br>An experience that sparks your curiosity",
	...
	"SECTION_TEAM_TITLE"		=> "YOURCONCIERGE TEAM",
        "SECTION_TEAM_SUBTITLE"		=> "Get to know us, how can we help you?",
        "SECTION_HOWTO_TITLE"		=> "HOW TO USE",
        "SECTION_HOWTO_SUBTITLE"	=> "From you to us - how to get in touch with us",
...
$lang = array_merge($lang,array(
	...
	"HOWTO_2_TITLE"                 => "2.Make a request",
        ...
        "HOWTO_3_DESC"                  => "We usually take 3-5 days to give to fulfill your request, though some requests may take more time (we will be in contact if this is the case).<br>For each request, we usually give three suggestions.<br>If we have any questions regarding the request, we will let you know. ",
...
switch ($_SERVER['SERVER_NAME']) {
	...
	"CONTACTUS_1_TITLE"                  => "Contact Information",
        ...
        $lang['POPUP_WELCOME_TITLE'] = "The registration procedure is complete.";
        $lang['POPUP_WELCOME_SUBTITLE'] = "The registration procedure is complete.";
...
case 'ppe.yourconcierge.jp':    
    ...
    case 'muromachi-mot-lounge.yourconcierge.jp':  
        ...
        $lang['FRM_EMPLOYEE_ID_DESC'] = '(You can confirm your mot. ID from the top page of the mot. member\'s site by either using the menu on the top left or via the membership card button.)';
        //TEAM
       $lang = array_merge($lang,array(
            "TEAM_1"                       => $team['KIMURA'],          
            "TEAM_2"                       => $team['KURIYAMA'],
        ...
        $lang = array_merge($lang,array(
            "CONTACTUS_1_TITLE"                  => "Contact Information",
            "CONTACTUS_1_BODY"                   => "<li>Visit us:  mot. Member's Lounge<br>Nihonbashi Muromachi Tower ,6th Floor</li><li>Call us: 03-6271-8593</li><li>Business Hours: Weekday 8:00-21:00</li>",       
            "CONTACTUS_2_TITLE"                  => FALSE,
	));        
    ...
    case 'family.yourconcierge.jp':
       ...
       $lang = array_merge($lang,array(
        ...
        $lang['HOWTO_2_DESC'] = "We look forward to helping with your needs. Please visit us at the concierge desk.<br>For those who cannot come in person, you can call or send a message through our system.<br><br>◆<strong>Start of Video Concierge!</strong><br>Get started by launching the Teams app, search for the ID below, and try video calls.<br><strong>Teams ID : Yourconcierge</strong><br>*Through Teams app we only accept video call requests.";
        $lang['HOWTO_4_TITLE'] = NULL;
        $lang['HOWTO_5_TITLE'] = NULL;
        $lang['HOWTO_6_TITLE'] = NULL;
